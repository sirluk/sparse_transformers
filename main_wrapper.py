...
subprocess.call('python3 main.py --modular --gpu_id=3 --seed=0 --modular_adv_task_head=True --fixmask_pct=0.01 --model_name="bert-base-uncased" --ds="pan16"' + suffix, shell=True)

subprocess.call('python3 main.py --modular --gpu_id=3 --seed=0 --modular_adv_task_head=True --fixmask_pct=0.02 --model_name="bert-base-uncased" --ds="pan16"' + suffix, shell=True)
...
subprocess.call('python3 main.py --baseline --modular --gpu_id=3 --seed=0 --modular_adv_task_head=True --model_name="bert-base-uncased" --ds="pan16"' + suffix, shell=True)
...
subprocess.call('python3 main.py --baseline --modular --gpu_id=3 --seed=0 --modular_adv_task_head=True --model_name="bert-base-uncased" --ds="bios"' + suffix, shell=True)
