...
class ModularDiffModel_2attr(ModularDiffModel):
    ...
    def _step(
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            for _ in range(concrete_samples):
                ...
                losses_debiased += torch.tensor([loss, loss_task_adv, loss_protected, loss_attr_bias, loss_l0_adv]).detach()
            ...
            losses_dict = {
                ...
                "attr_bias": losses_debiased[3],
                "l0_adv": losses_debiased[4]
            }
    ...
    def save_checkpoint(
        ...
        info_dict = {
            ...
            "attr_bias_head": self.attr_bias_head,
