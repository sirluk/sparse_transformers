...
from src.model_task import DiffNetworkTask
...
def main(base_args, args_train, args_attack):    
    ...
    method = "diff_pruning_adverserial" if args_train.adverserial else "diff_pruning_task"
    logger_name = "_".join([
        method,
...
if __name__ == "__main__":
    ...
    args_train = argparse.Namespace(**{**cfg["train_config_diff_pruning"], **cfg["data_config"]})
